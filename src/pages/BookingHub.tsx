...
function BookingFormOverlay({ item, onClose }: { item: BookingItem; onClose: () => void }) {
  ...
  const [form, setForm] = useState({
    ...
    name: "", email: "", phone: "", mobileNumber: "",
    date: new Date().toISOString().split("T")[0],
    time: "09:00",
    // quantities
    guests: 1, nights: 1, tickets: 1,

    // location & transport
    country: "", city: "", currentLocation: "", destinationFarm: "",
    pickupLocation: "", dropoffLocation: "",
    transportCategory: "Road Transport", transportOption: "Self Drive", tripType: "One-way",
    preferredVehicle: "Sedan", vehicleType: "Sedan", driverName: "", vehicleRegistration: "",
    distanceKm: 10, estimatedTravelTime: "20 mins",

    // passenger breakdown
    adults: 2, children: 0, infants: 0, seniors: 0, luggage: 1, pets: 0,

    // guest identity
    nationality: "", gender: "", age: "", dateOfBirth: "", nationalId: "", homeAddress: "", emergencyContact: "",
    guestNames: "", specialNeeds: "", accessibilityNeeds: "", accessibilityRequirements: "", specialRequests: "",

    // farm-stay specifics
    accommodationType: "", roomNumber: "", occupancy: "", bookingReference: "", checkOutDate: "", arrivalTime: "", departureTime: "",
    purposeOfVisit: "Leisure", farmExperiencePackage: "",

    // meal & activity
    mealPlan: "", activityPlan: "", equipmentRental: "",
    ...
    airConditioning: false, wifi: false, childSeat: false, femaleDriver: false, englishSpeakingDriver: false, localGuide: false, luxuryVehicle: false, farmGuideIncluded: false,

    // extras & billing
    babyCot: false, extraBed: false, laundry: false, spa: false, swimmingPool: false, gym: false, conferenceRoom: false, bbqEquipment: false, bicycleRental: false, fishingEquipment: false, horseRental: false,
    paymentMethod: "Pay at Restaurant", paymentStatus: "Pending", invoiceNumber: "", receiptNumber: "", amountPaid: "", balance: "", discount: "", taxes: "",
    roomPreference: "", bedPreference: "", pillowPreference: "", smoking: false,

    // misc
    trainingTopic: "", serviceType: "", notes: "",
  });
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const booking = createBooking(item, form as Record<string, unknown>, form.paymentMethod);
